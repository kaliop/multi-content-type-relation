...
import { Loader, Field, TextInput, TooltipProvider } from "@strapi/design-system"
...
const MainInput = ({ name, error, description, onChange, value, labelAction, label, attribute, required }: Props) => {
  ...
  const onEntriesSorted = (entries: SelectedEntry[]) => {
    setSelected(entries)
  }
